...
Generated: 20260618-143726

## Delta vs vòng `142543`

- `single_doc_ready_count`: 10 → **10** (Δ 0.0)
- `single_extraction_success_rate_on_ready`: 1.0 → **0.8** (Δ -0.2)
- `single_extraction_success_rate_all`: 0.5 → **0.4** (Δ -0.1)
- `wrong_row_risk_count`: None → **0** (Δ None)
- `quant_aggregation_success_rate`: 0.5 → **0.2** (Δ -0.3)
- `aggregation_success_rate`: 0.3333 → **0.1333** (Δ -0.2)
- `aggregation_conflict_rate`: 0.2 → **0.0** (Δ -0.2)
- `aggregation_partial_rate`: 0.1333 → **0.1333** (Δ 0.0)
...
- `single_extraction_success_rate_on_ready`: **0.8**
- `single_extraction_success_rate_all`: **0.4**
- `wrong_row_risk_count`: **0**
- `wrong_row_risk_rate_on_ready`: **0.0**
- `single_fail_breakdown`: **{'ready': 8, 'retrieval_gap': 10, 'extraction_gap': 2}**

## Cross-doc (conflict resolution)

- `count`: **15**
- `quantitative_cross_count`: **10**
- `aggregation_success_rate`: **0.1333**
- `aggregation_partial_rate`: **0.1333**
- `aggregation_conflict_rate`: **0.0**
- `aggregation_missing_role_rate`: **1.0**
- `quant_aggregation_success_rate`: **0.2**
- `quant_resolution_rate`: **0.4**
...
- **QUANT-0133**: status=partial reason=missing_roles:doc_02_ghg_energy,doc_03_renewable,doc_07_certification,doc_evidence_csv
- **QUANT-0134**: status=partial reason=missing_roles:doc_02_ghg_energy,doc_03_renewable,doc_07_certification,doc_evidence_csv
