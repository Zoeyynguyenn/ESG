...
- Probes: **8**
- Parser OK rate: **1.0**
- Retrieval feasible: **0.875**
- Extraction feasible: **0.375**

## Architecture decision

- Expand holdout: **True**
- Open synthesis: **False**
- Weakest layer: **synthesis**
- Priority next: **abstraction_rule_registry**

Lane co 13 reusable rules / 27 total; demo quant synthesis-gate 0.2333; holdout retrieval 0.875; chua mo synthesis; can abstraction truoc full holdout.
