# Goldns/Emni RAG Eval Report (20260618-094834)
...
- answer_accuracy: **0.9851**
- abstain_accuracy: **1.0**
- overall_score: **0.9664**
...
- `answer_accuracy`: +0.0597 (v4=0.9254)
- `abstain_accuracy`: +0.0000 (v4=1.0)
- `overall_score`: +0.0149 (v4=0.9515)
...
- `answer_accuracy`: +0.0896 (v3=0.8955)
- `abstain_accuracy`: +0.0000 (v3=1.0)
- `overall_score`: +0.0672 (v3=0.8992)
...
- `answer_accuracy`: +0.1194 (v2=0.8657)
- `abstain_accuracy`: +0.0000 (v2=1.0)
- `overall_score`: +0.1194 (v2=0.847)
...
- `semantic_ambiguity`: 4
- `rule_extractor_gap`: 1
- `coverage_gap`: 2

## Coverage gap cases

- `goldns-0237` (goldns) family=fair_trade_sanction gap=coverage_gap fail_type=answer_correct_but_wrong_top1
- `goldns-0238` (goldns) family=fair_trade_sanction gap=coverage_gap fail_type=answer_correct_but_wrong_top1

### answer_fail examples

- `goldns-0208` (goldns) family=financial_capex gold=963 pred=Not disclosed top1=2025_재무_OFS.json
